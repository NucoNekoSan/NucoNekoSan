...
> 業務改善・データ活用・Web アプリ運用を軸に、**実務で使える仕組みづくり**に取り組んでいます。
> 要件整理、AI コーディング支援を活用した実装、Docker 運用、ドキュメント整備、保守しやすい改善サイクルを重視しています。
...
- AI コーディング支援を活用した Web アプリの実装・検証・改善
...
**AI 支援を活用したアプリ開発**
- 要件整理、仕様の分解、実装方針の検討
- AI コーディング支援による Django / FastAPI / Next.js 等の実装補助
- 生成コードの動作確認、エラー調査、修正方針の判断
- Docker / Docker Compose 環境での起動確認、ポート管理、運用前チェック
- README、運用手順、バックアップ・復旧手順の整備
